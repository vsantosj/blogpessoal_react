        ...
        <div className='border-slate-900 border 
            ...
            <section>
                <div className="flex w-full bg-indigo-400 py-2 px-4 items-center gap-4">
                    ...
                    <img src={posts.user?.photoUrl}
                        className='h-12 rounded-full' alt={`imagem do usuário ${posts.user?.name}`} />
                ...
                <div className='p-4 '>
                    ...
                    <p>{posts.content}</p>
                    <p>{posts.content}</p>
                    <p>Data Criação: {new Intl.DateTimeFormat("pt-BR", {
                        dateStyle: 'full',
                        timeStyle: 'medium',
                    }).format(new Date(posts.created_at))}</p>
                </div>
            </section>
